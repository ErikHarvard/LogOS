...
| every mutant actually mutates (94; 88 until F25's three `lrs*_mut` and F26's `lf*_mut` + nd_m4) | `freezeck.py` M | 94/94 change ≥1 line; 0 shadowed | yes — fixture that matches nothing is flagged |
