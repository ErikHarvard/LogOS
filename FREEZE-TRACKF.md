...
| every mutant actually mutates (91; 88 until F25's three `lrs*_mut`) | `freezeck.py` M | 91/91 change ≥1 line; 0 shadowed | yes — fixture that matches nothing is flagged |
