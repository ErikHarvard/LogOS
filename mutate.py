...
MUTANTS = [
 ...
 # ── M11b (ancestry.la, GENERATED from ancestry_spec.la): one targeted mutant per gate row it must redden.
 ('ancestry.la', 'ancestry-drops-right-parent',
  'la n. n(la nm. NILA)(la a. la b. CONSA(a)(CONSA(b)(NILA)))(la a. la b. CONSA(a)(CONSA(b)(NILA)))(la a. la b. CONSA(a)(CONSA(b)(NILA)))(la a. la b. CONSA(a)(CONSA(b)(NILA)))(la a. CONSA(a)(NILA))',
  'la n. n(la nm. NILA)(la a. la b. CONSA(a)(NILA))(la a. la b. CONSA(a)(NILA))(la a. la b. CONSA(a)(NILA))(la a. la b. CONSA(a)(NILA))(la a. CONSA(a)(NILA))',
  'the walk descends only into the FIRST parent of each binary node, so whole branches of the lineage vanish and the entries fall short of TSIZE; ONLY A2-complete is read',
  ['sh','-c','./tiny_host ancestry_gate.la | grep -oE "A2-complete (OK|FAIL)"']),
 ('ancestry.la', 'ancestry-stops-one-short',
  'ZA(la self. la l. l(NILA)(la h. la t. CONSA(l)(self(NEXTGEN(l)))))',
  'ZA(la self. la l. l(NILA)(la h. la t. IFA(ISNILA(NEXTGEN(l)))(la _. NILA)(la _. CONSA(l)(self(NEXTGEN(l))))))',
  'the walk stops one generation before the leaves: the nine are never reached and every depth reads one short; ONLY A4-depth is read',
  ['sh','-c','./tiny_host ancestry_gate.la | grep -oE "A4-depth (OK|FAIL)"']),
 ('ancestry.la', 'ancestry-dyad-everywhere',
  'la n. (la ls. (la v. la b. IFA(v)(la _. IFA(b)(la _. "VOID,BEING")(la _. "VOID"))(la _. IFA(b)(la _. "BEING")(la _. "—")))(HASNAME("VOID")(ls))(HASNAME("BEING")(ls)))(LEAVES(n))',
  'la n. "VOID,BEING"',
  'every glyph is reported as reaching both members of the dyad, whatever its leaves; ONLY A5-dyad is read',
  ['sh','-c','./tiny_host ancestry_gate.la | grep -oE "A5-dyad (OK|FAIL)"']),
