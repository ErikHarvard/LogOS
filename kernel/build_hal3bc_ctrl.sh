...
#   ata3b.la --(native_codegen3)--> native_codegen3_out --> kernel_hal3b_ctrl.elf
...
echo "[4/5] link -> kernel_hal3b_ctrl.elf (elf64 -> elf32-i386 container)"
ld -n -T kernel/kernel.ld kernel/boot.o -o kernel/kernel_hal3b_ctrl_64.elf
objcopy -O elf32-i386 kernel/kernel_hal3b_ctrl_64.elf kernel/kernel_hal3b_ctrl.elf
...
echo "OK: kernel/kernel_hal3b_ctrl.elf + kernel/hal3bdisk.img"
