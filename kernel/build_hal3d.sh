...
#   ata.la --(native_codegen3)--> native_codegen3_out --> kernel_hal3d.elf (ring-0)
...
echo "[1/5] compile ata3d.la (self-repairing) via native_codegen3"
cp kernel/ata3d.la native_input.la
...
echo "[4/5] link -> kernel_hal3d.elf (elf64 -> elf32-i386 container)"
ld -n -T kernel/kernel.ld kernel/boot.o -o kernel/kernel_hal3d_64.elf
objcopy -O elf32-i386 kernel/kernel_hal3d_64.elf kernel/kernel_hal3d.elf
...
echo "OK: kernel/kernel_hal3d.elf + kernel/hal3disk.img"
