...
#   e_entry --> entry.inc ; boot.asm (default ring-0 path) + incbin --> kernel_mouse.elf
...
cp kernel/mouse.la native_input.la
...
echo "[4/4] link -> kernel_mouse.elf (elf64), repackage container as elf32-i386"
ld -n -T kernel/kernel.ld kernel/boot.o -o kernel/kernel_mouse_64.elf
objcopy -O elf32-i386 kernel/kernel_mouse_64.elf kernel/kernel_mouse.elf

echo "OK: kernel/kernel_mouse.elf"
